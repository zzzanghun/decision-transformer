...
class RewardModel(nn.Module):
    ...
    def forward(self, drone_info, obs, path):
        ...
        combined_features = torch.cat([obs_path_features, drone_features], dim=-1)
        # 보상 예측
    ...
    def get_trainable_parameters(self):
        ...
        return list(self.drone_info_encoder.parameters()) + list(self.reward_predictor.parameters()) + list(self.obs_path_encoder.parameters())